  ...
  <div class="main">
    ...
    <div class="sl_container" id="scrollDiv">
      <div class="topDiv">
        ...
        <!-- 跳转的图片列表 -->
        <commonModules :orgId="orgInfo.id" :groupId="groupInfo.id" :friendFlag="friendFlag? true : false"
                ...
                <template v-else>
                  <div :class="message.from == userInfo.useruuid ? 'rightIconDiv' : 'leftIconDiv'">
                    <template v-if="message.type == 'TIMTextElem'">
                      <div class="contentDiv" :class="message.from == userInfo.useruuid ? 'rightIconContent': 'leftIconContent'"
                        v-html="message.msg"></div>
                    </template>
            ...
            <van-row>
              ...
              <van-col span="18">
                <div style="padding: 5px;">
                  <van-field v-model="message" @keyup="changeIcon()" @input="changeIcon()" style="padding: 5px;border-radius: 5px;background-color: #F3F3F3;border-bottom: 0.5px solid #95999C;"
