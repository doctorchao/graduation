  ...
  methods: {
    pickTab(val){
        if(val == 'pick1'){
            ...
            this.pick4 = false,
            this.pick5 = true,
            // this.$router.push('/unitZhiBo/pictureWall')
            this.$router.replace(`/unitZhiBo/orgPictureWall/${this.dwId}?token=${this.token}`)
        }else if(val == 'pick2'){
            this.pick1 = false,
            this.pick2 = true,
            this.pick3 = false,
            this.pick4 = false,
            this.pick5 = true,
            this.$router.replace(`/unitZhiBo/orgShortVideo/${this.dwId}?token=${this.token}`)
        }else if(val == 'pick3'){
            this.pick1 = false,
            this.pick2 = false,
            this.pick3 = true,
            this.pick4 = false,
            this.pick5 = true,
            this.$router.replace(`/unitZhiBo/miniRecommendLiveList?token=${this.token}&dwId=${this.dwId}`)
        }else if(val == 'pick4'){
            this.pick4 = true,
            this.pick5 = false,
            this.$router.replace(this.pick1 ?`/unitZhiBo/focusPictureWall?token=${this.token}&dwId=${this.dwId}`:(this.pick2 ?`/unitZhiBo/focusShortVideo?token=${this.token}&dwId=${this.dwId}`:`/unitZhiBo/miniFocusLiveList?token=${this.token}&dwId=${this.dwId}`))
        }else if(val == 'pick5'){
            this.pick4 = false,
            this.pick5 = true,
            this.$router.replace(this.pick1 ?`/unitZhiBo/orgPictureWall/${this.dwId}?token=${this.token}`:(this.pick2 ?`/unitZhiBo/orgShortVideo/${this.dwId}?token=${this.token}`:`/unitZhiBo/miniRecommendLiveList?token=${this.token}&dwId=${this.dwId}`))
        }
    },
    checkUrl(){
      console.log(this.$route,'路由信息')
      if(this.$route.path == `/unitZhiBo/orgPictureWall/${this.dwId}`){
        this.pick1 = true,
        this.pick2 = false,
        this.pick3 = false,
        this.pick4 = false,
        this.pick5 = true
      }else if(this.$route.path == `/unitZhiBo/orgShortVideo/${this.dwId}`){
        this.pick1 = false,
        this.pick2 = true,
        this.pick3 = false,
        this.pick4 = false,
        ...
        this.pick4 = false,
        this.pick5 = true
      }else if(this.$route.path == `/unitZhiBo/focusPictureWall`){
        this.pick1 = true,
        this.pick2 = false,
        this.pick3 = false,
        this.pick4 = true,
        this.pick5 = false
      }else if(this.$route.path == `/unitZhiBo/focusShortVideo`){
        this.pick1 = false,
        this.pick2 = true,
        this.pick3 = false,
        this.pick4 = true,
        this.pick5 = false
      }else if(this.$route.path == '/unitZhiBo/miniFocusLiveList'){
        this.pick1 = false,
        this.pick2 = false,
        this.pick3 = true,
        this.pick4 = true,
      ...
      if((this.reduceX<= (-20))&&(Math.abs(this.reduceY)<=30)){
        switch(true){
          ...
          case (this.pick1&&this.pick5):
            ...
            this.pick4 = true;
            this.pick5 = false;
            this.$router.replace(`/unitZhiBo/focusShortVideo?token=${this.token}&dwId=${this.dwId}`)
          break;
          ...
          case (this.pick2&&this.pick5):
            ...
            this.pick4 = true;
            this.pick5 = false;
            this.$router.replace(`/unitZhiBo/miniFocusLiveList?token=${this.token}&dwId=${this.dwId}`)
          break;
        ...
        switch(true){
          ...
          case (this.pick1&&this.pick5):
            ...
            this.pick4 = true;
            this.pick5 = false;
            this.$router.replace(`/unitZhiBo/focusPictureWall?token=${this.token}&dwId=${this.dwId}`)
          break;
        }
      }
    }
