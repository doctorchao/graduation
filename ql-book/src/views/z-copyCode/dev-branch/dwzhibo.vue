  ...
  methods: {
    pickTab(val){
      if(val == 'pick1'){
          this.pick1 = true,
          this.pick2 = false,
          this.$router.replace(`/dwZhiBo/miniFocusLiveList?token=${this.token}&dwId=${this.zbId}`)
      }else if(val == 'pick2'){
          this.pick1 = false,
          this.pick2 = true,
          this.$router.replace(`/dwZhiBo/miniRecommendLiveList?token=${this.token}&dwId=${this.zbId}`)
      }
    },
    checkUrl(){
      if(this.$route.path == '/dwZhiBo/miniFocusLiveList'){
        this.pick1 = true,
        this.pick2 = false
