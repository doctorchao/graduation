...
const GoodsDetailCopy = resolve => require.ensure([], () => resolve(require('../pages/gr/goods/GoodsDetailCopy.vue')));
...
const DwGroupList = resolve => require.ensure([], () => resolve(require('../pages/group/DwGroupList.vue')));
...
// 我的卡包-卡包详情
const userCardDetail = resolve => require.ensure([], () => resolve(require('../pages/my/UserCardDetail')))
// 我的卡包-优惠券详情
const userCouponDetail = resolve => require.ensure([], () => resolve(require('../pages/my/UserCouponDetail.vue')))
// 商家卡包详情
...
var cardPromotion = resolve => require.ensure([],() => resolve(require('../pages/my/CardPromotion')))

// 票券商品属性设置
var serviceSetting = resolve => require.ensure([], () => resolve(require("../pages/tickets/serviceSetting")))
// 票券服务设置
var goodsPropSetting = resolve => require.ensure([], () => resolve(require("../pages/tickets/goodsPropSetting")))
// 票券时间价格设置
var dateAndPrice = resolve => require.ensure([], () => resolve(require("../pages/tickets/dateAndPrice")))
// 票券占位设置
var seatSetting = resolve => require.ensure([], () => resolve(require("../pages/tickets/seatSetting")))
// 票券详情
var ticketDetail = resolve => require.ensure([], () => resolve(require("../pages/tickets/ticketDetail")))
// 票券商品详情
var buyGoods = resolve => require.ensure([], () => resolve(require("../pages/tickets/buyGoods")))
...
let router = new Router({
  routes: [
    {
      path: '/userCouponDetail/:cardId?',
      name: 'userCouponDetail',
      component: userCouponDetail
    },
    {
      path: '/cardPromotion/:cardId?',
      name: 'cardPromotion',
    ...
    {
      path: '/goodsDetailCopy/:goodsId',
      name: 'GoodsDetailCopy',
      component: GoodsDetailCopy,
      props: true
    },
    {
    ...
    },
    {
      ...
      redirect: to =>{
        ...
        if(query.dwId){
          ...
          return `/unitZhiBo/orgShortVideo/${query.dwId}`
        }
      },
      component: unitZhiBo,
      props: true,
    ...
    },
    {
      path: "/dwZhiBo",
      name: "dwZhiBo",
      redirect: '/dwZhiBo/miniRecommendLiveList',
      component: dwZhiBo,
      props: true,
      children:[
        {
    ...
    {
      path : "/goodsPropSetting",
			name : "goodsPropSetting",
			component : goodsPropSetting
    },
    {
      path : "/serviceSetting",
			name : "serviceSetting",
...
router.beforeEach((to, from, next) => {
  ...
  if(
    ...
    ||(to.name.toLowerCase() == 'access'.toLowerCase())
    ){
		next();
    return;
  }
...
const indexGoNext = (WEIXIN_WINDOW, SMALL_PROGRAM, to, from, next) => {
  ...
  if (
    ...
    to.name.toLowerCase() == 'openResContent'.toLowerCase()
  ) {
