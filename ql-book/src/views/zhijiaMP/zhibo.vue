  ...
  methods: {
    pickTab(val){
        if(val == 'pick1'){
            ...
            this.pick4 = true,
            this.pick5 = false,
            this.$router.replace(this.pick1 ?`/zhiBo/orgPictureWall/${this.dwId}?token=${this.token}`:(this.pick2 ?`/zhiBo/orgShortVideo/${this.dwId}?token=${this.token}`:`/zhiBo/miniFocusLiveList?token=${this.token}&dwId=${this.zbId}`))
        }else if(val == 'pick5'){
            this.pick4 = false,
            this.pick5 = true,
    ...
    checkUrl(){
      ...
      if(this.$route.path == '/zhiBo/pictureWall'){
        ...
        this.pick4 = false,
        this.pick5 = true
      }else if(this.$route.path == `/zhiBo/orgPictureWall/${this.dwId}`){
        this.pick1 = true,
        this.pick2 = false,
        this.pick3 = false,
        this.pick4 = true,
        this.pick5 = false
      }else if(this.$route.path == `/zhiBo/orgShortVideo/${this.dwId}`){
        this.pick1 = false,
        this.pick2 = true,
        this.pick3 = false,
        this.pick4 = true,
      ...
      if((this.reduceX<= (-20))&&(Math.abs(this.reduceY)<=30)){
        switch(true){
          ...
          case (this.pick1&&this.pick5):
            ...
            this.pick4 = true;
            this.pick5 = false;
            this.$router.replace(`/zhiBo/orgShortVideo/${this.dwId}?token=${this.token}`)
          break;
        ...
        switch(true){
          ...
          case (this.pick1&&this.pick5):
            ...
            this.pick4 = true;
            this.pick5 = false;
            this.$router.replace(`/zhiBo/orgPictureWall/${this.dwId}?token=${this.token}`)
          break;
        }
      }
    }
